...
const mostrarCriadores5 = () =>{
    Swal.fire({
        title: 'Aluno(a)',
        text: 'Marcelo - 7099005',
        imageUrl: '../imagens/marcelo.jpg',
        imageWidth: 400,
        imageHeight: 400,
        imageAlt: 'Custom image',
        animation: true
...
/*sumir/aparecer Frase
const sumirFrase = () =>{
        document.getElementById("#frase").classList.add(".frase1");
        return true;
    }  
    const aparecerFrase = () =>{
        document.getElementById("#frase").remove.add(".frasee");   
    }

    const aparecerFrase2 = () =>{
        setInterval(aparecerFrase, 6000);
        return true;
    }
    

    if(aparecerFrase2() == true){
        setInterval(sumirFrase,7000);
    }*/
